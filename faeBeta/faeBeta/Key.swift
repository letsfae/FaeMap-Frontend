...
class Key: NSObject { //  singleton class
    ...
    func writeInRealmCategory(category: String, weight: Double) {
        let realm  = try! Realm()
    ...
    func visitCategory(category: String) {
        ...
        if class5.contains(category) {
            level1 = category
            for key in class4_to_5.keys {
                if class4_to_5[key] != nil && !(class4_to_5[key]?.isEmpty)! && (class4_to_5[key]?.contains(level1))! {
                    level2 = key
                }
            }
            
            if (level2 != "") {
                for key in class3_to_4.keys {
                    if class3_to_4[key] != nil && !(class3_to_4[key]?.isEmpty)! && (class3_to_4[key]?.contains(level2))! {
                        level3 = key
                    }
                }
            }
            ...
            if (level3 != "") {
                for key in class2_to_3.keys {
                    if class2_to_3[key] != nil && !(class2_to_3[key]?.isEmpty)! && (class2_to_3[key]?.contains(level3))! {
                        level4 = key
                    }
                }
            }
            ...
            if (level4 != "") {
                for key in class1_to_2.keys {
                    if class1_to_2[key] != nil && !(class1_to_2[key]?.isEmpty)! && (class1_to_2[key]?.contains(level4))! {
                        level5 = key
                    }
                }
            }
        } else if class4_to_5[category] != nil {
            level1 = category
            for key in class3_to_4.keys {
                if class3_to_4[key] != nil && !(class3_to_4[key]?.isEmpty)! && (class3_to_4[key]?.contains(level1))! {
                    level2 = key
                }
            }
            ...
            if (level2 != "") {
                for key in class2_to_3.keys {
                    if class2_to_3[key] != nil && !(class2_to_3[key]?.isEmpty)! && (class2_to_3[key]?.contains(level2))! {
                        level3 = key
                    }
                }
            }
            ...
            if (level3 != "") {
                for key in class1_to_2.keys {
                    if class1_to_2[key] != nil && !(class1_to_2[key]?.isEmpty)! && (class1_to_2[key]?.contains(level3))! {
                        level4 = key
                    }
                }
            }
            ...
            for key in class2_to_3.keys {
                if class2_to_3[key] != nil && !(class2_to_3[key]?.isEmpty)! && (class2_to_3[key]?.contains(level1))! {
                    level2 = key
                }
            }
            ...
            if (level2 != "") {
                for key in class1_to_2.keys {
                    if class1_to_2[key] != nil && !(class1_to_2[key]?.isEmpty)! && (class1_to_2[key]?.contains(level2))! {
                        level3 = key
                    }
                }
            }
            ...
            for key in class1_to_2.keys {
                if class1_to_2[key] != nil && !(class1_to_2[key]?.isEmpty)! && (class1_to_2[key]?.contains(level1))! {
                    level2 = key
                }
            }
        ...
        if level5 != "" {
            writeInRealmCategory(category: level4, weight: base * factor * factor * factor * factor)
        }
    }
