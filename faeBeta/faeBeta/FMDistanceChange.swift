...
extension FaeMapViewController {
    ...
    func printSliderValue(_ sender: UISlider) {
        let points = self.faeMapView.convert(LocManage.shared.curtLoc.coordinate, toPointTo: nil)
//        let radius = Int(faeMapView.projection.points(forMeters: Double(sender.value)*1000.0, at: LocManage.shared.curtLoc.coordinate))
