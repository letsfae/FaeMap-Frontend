...
class SetFaeInc: UIViewController {
    ...
    func loadContent() {
        ...
        imgviewFae = UIImageView(frame: CGRect(x: 50, y: 120, w: 50, h: 40))
        ...
        lblTitle = UILabel(frame: CGRect(x: 50, y: 190, w: 140 / screenWidthFactor, h: 28 / screenHeightFactor))
        ...
        lblContent = UILabel(frame: CGRect(x: 50, y: 242, w: screenWidth / screenWidthFactor - 100 , h: 220 / screenHeightFactor))
