 ...
 */
@protocol JSQMessagesCollectionViewCellDelegateCustom <NSObject>
 ...
 */
@interface JSQMessagesCollectionViewCellCustom : UICollectionViewCell
 ...
 */
@property (weak, nonatomic) id<JSQMessagesCollectionViewCellDelegateCustom> delegate;
