...
#import "JSQMessagesCollectionViewDelegateFlowLayoutCustom.h"
#import "JSQMessagesCollectionViewDataSourceCustom.h"
 ...
 */
@interface JSQMessagesCollectionViewCustom : UICollectionView <JSQMessagesCollectionViewCellDelegateCustom>

/**
 *  The object that provides the data for the collection view.
 *  The data source must adopt the `JSQMessagesCollectionViewDataSource` protocol.
 */
@property (weak, nonatomic) id<JSQMessagesCollectionViewDataSourceCustom> dataSource;

/**
 *  The object that acts as the delegate of the collection view. 
 *  The delegate must adopt the `JSQMessagesCollectionViewDelegateFlowLayout` protocol.
 */
@property (weak, nonatomic) id<JSQMessagesCollectionViewDelegateFlowLayoutCustom> delegate;

/**
 *  The layout used to organize the collection view’s items.
 */
@property (strong, nonatomic) JSQMessagesCollectionViewFlowLayoutCustom *collectionViewLayout;
