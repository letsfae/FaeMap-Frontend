...
@class JSQMessagesComposerTextViewCustom;

/**
 *  A delegate object used to notify the receiver of paste events from a `JSQMessagesComposerTextView`.
 */
@protocol JSQMessagesComposerTextViewPasteDelegateCustom <NSObject>
 ...
 */
- (BOOL)composerTextView:(JSQMessagesComposerTextViewCustom *)textView shouldPasteWithSender:(id)sender;
