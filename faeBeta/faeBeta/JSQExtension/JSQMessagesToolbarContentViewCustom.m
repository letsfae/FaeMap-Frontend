...
@interface JSQMessagesToolbarContentViewCustom ()

@property (weak, nonatomic) IBOutlet JSQMessagesComposerTextViewCustom *textView;
...
@implementation JSQMessagesToolbarContentViewCustom

#pragma mark - Class methods

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([JSQMessagesToolbarContentViewCustom class])
                          bundle:[NSBundle bundleForClass:[JSQMessagesToolbarContentViewCustom class]]];
}
