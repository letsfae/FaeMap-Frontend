...
@interface JSQMessagesCollectionViewCellCustom ()
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    if ([self isKindOfClass:[JSQMessagesCollectionViewCellIncomingCustom class]]) {
        self.avatarViewSize = customAttributes.incomingAvatarViewSize;
    }
    else if ([self isKindOfClass:[JSQMessagesCollectionViewCellOutgoingCustom class]]) {
