...
@interface JSQPhotoMediaItemCustom ()
...
@implementation JSQPhotoMediaItemCustom
...
{
    JSQPhotoMediaItemCustom *copy = [[JSQPhotoMediaItemCustom allocWithZone:zone] initWithImage:self.image];
