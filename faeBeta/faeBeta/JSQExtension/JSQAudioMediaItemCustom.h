...
@class JSQAudioMediaItemCustom;

NS_ASSUME_NONNULL_BEGIN

@protocol JSQAudioMediaItemDelegateCustom <NSObject>
 ...
 */
- (void)audioMediaItem:(JSQAudioMediaItemCustom *)audioMediaItem
didChangeAudioCategory:(NSString *)category
               options:(AVAudioSessionCategoryOptions)options
                 error:(nullable NSError *)error;

- (void)audioMediaItemDidStartPlayingAudio:(JSQAudioMediaItemCustom *)audioMediaItem
                               audioButton:(UIButton *)sender;
 ...
 */
@interface JSQAudioMediaItemCustom : JSQMediaItem <JSQMessageMediaData, AVAudioPlayerDelegate, NSCoding, NSCopying>

/**
 *  The delegate object for audio event notifications.
 */
@property (nonatomic, weak, nullable) id<JSQAudioMediaItemDelegateCustom> delegate;

/**
 *  The view attributes to configure the appearance of the audio media view.
 */
@property (nonatomic, strong, readonly) JSQAudioMediaViewAttributesCustom *audioViewAttributes;
...
- (instancetype)initWithData:(nullable NSData *)audioData
         audioViewAttributes:(JSQAudioMediaViewAttributesCustom *)audioViewAttributes NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return  An initialized `JSQAudioMediaItem`.
 */
- (instancetype)initWithAudioViewAttributes:(JSQAudioMediaViewAttributesCustom *)audioViewAttributes;
