...
@interface JSQAudioMediaItemCustom ()
...
@implementation JSQAudioMediaItemCustom

#pragma mark - Initialization

- (instancetype)initWithData:(NSData *)audioData audioViewAttributes:(JSQAudioMediaViewAttributesCustom *)audioViewAttributes
{
...
{
    return [self initWithData:audioData audioViewAttributes:[[JSQAudioMediaViewAttributesCustom alloc] init]];
}
...
- (instancetype)init
{
    return [self initWithData:nil audioViewAttributes:[[JSQAudioMediaViewAttributesCustom alloc] init]];
}
...
- (BOOL)isEqual:(id)object
{
    ...
    JSQAudioMediaItemCustom *audioItem = (JSQAudioMediaItemCustom *)object;
...
{
    JSQAudioMediaItemCustom *copy = [[[self class] allocWithZone:zone] initWithData:self.audioData
