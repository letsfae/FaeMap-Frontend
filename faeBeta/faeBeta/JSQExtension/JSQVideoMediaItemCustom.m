...
- (UIView *)mediaView
{
    ...
    //if (self.cachedVideoImageView == nil) {
        ...
        if (self.snapImage != nil) {
            ...
            imageView = [[UIImageView alloc] initWithImage:self.snapImage];
            
            UIImageView *playImageView = [[UIImageView alloc] initWithImage:playIcon];
            playImageView.frame = CGRectMake(size.width / 2 - playIcon.size.width / 2, size.height / 2 - playIcon.size.height / 2 - 5,playIcon.size.width,playIcon.size.height);
