...
class MyFaeViewController: UIViewController  {
    ...
    var buttonNoDistrub : UIButton!
    var labelNoDistrub : UILabel!
    var buttonBusy : UIButton!
    var labelBusy : UILabel!
    var buttonAway : UIButton!
    var labelAway : UILabel!
    var buttonInvisible : UIButton!
    var labelInvisible : UILabel!
    var buttonOffline : UIButton!
    var labelOffline : UILabel!
    var underlineInputView : UIView!
...
extension MyFaeViewController: UITextFieldDelegate {//my status
    func statusViewInitial(){
        viewStatusBackground = UIView()
        buttonBackground = UIButton()
        viewStatus = UIView()
        buttonOnline = UIButton()
        labelOnline = UILabel()
        buttonNoDistrub = UIButton()
        labelNoDistrub = UILabel()
        buttonBusy = UIButton()
        labelBusy = UILabel()
        buttonAway = UIButton()
        labelAway = UILabel()
        buttonInvisible = UIButton()
        labelInvisible = UILabel()
        buttonOffline = UIButton()
        labelOffline = UILabel()
        underlineInputView = UIView()
        textInputView = UITextField()
        buttonCancel = UIButton()
        labelInputNumber = UILabel()
        viewStatusBackground.addSubview(buttonBackground)
    ...
    func addStatusView(){
        ...
        viewStatusBackground.frame = CGRectMake(0,0,screenWidth,screenHeight)
        buttonBackground.frame = CGRectMake(0,0,screenWidth,screenHeight)
        buttonBackground.addTarget(self, action: "statusViewCancel", forControlEvents: .TouchUpInside)
        viewStatusBackground.backgroundColor = UIColor(colorLiteralRed: 107/255, green: 105/255, blue: 105/255, alpha: 0.5)
        
        viewStatus.frame = CGRectMake(32,106,350,333)
        viewStatus.layer.cornerRadius = 26
        viewStatus.backgroundColor = UIColor.whiteColor()
        
        buttonOnline.frame = CGRectMake(50,67,50,50)
        ...
        labelOnline.frame = CGRectMake(87-32,230-106,39,10)
        ...
        buttonNoDistrub = UIButton(frame: CGRectMake(150,67,50,50))
        ...
        labelNoDistrub.frame = CGRectMake(175-32,230-106,63,10)
        ...
        buttonBusy.frame = CGRectMake(250,67,50,50)
        ...
        labelBusy.frame = CGRectMake(294-32,230-106,27,13)
        ...
        buttonAway.frame = CGRectMake(50,160,50,50)
        ...
        labelAway.frame = CGRectMake(91-32,323-106,32,13)
        ...
        buttonInvisible.frame = CGRectMake(150,160,50,50)
        ...
        labelInvisible.frame = CGRectMake(184-32,323-106,46,10)
        ...
        buttonOffline.frame = CGRectMake(250,160,50,50)
        ...
        labelOffline.frame = CGRectMake(288-32,323-106,39,11)
        ...
        textInputView.frame = CGRectMake(44,249,262,21)
